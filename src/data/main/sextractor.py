...
plt.scatter(x,sdssr_stpetro_calc,s=15, c='r',label='calculated petro rmag (st)')
plt.scatter(x,sdssr_abpetro_calc,s=15, c='b',label='calculated petro rmag (ab)')
...
plt.scatter(x,sdssr_cat,s=15, c='g',label='catalog rmag')
plt.xlabel('ECOID')
plt.ylabel('rmag')

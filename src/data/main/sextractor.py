...
plt.scatter(x,sdssr_stpetro_calc,s=30, c='r',label='calculated petro rmag (st)')
plt.scatter(x,sdssr_abpetro_calc,s=30, c='b',label='calculated petro rmag (ab)')
...
plt.scatter(x,sdssr_cat,s=30, c='g',label='catalog rmag')
plt.xlabel('ECOID')
plt.ylabel('rmag')
